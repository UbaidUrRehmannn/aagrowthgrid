...
const CommunityServices = ({ style, lines, data, heading }) => {
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          {data.map((feature, index) => (
            <div key={feature.id} className="col-lg-3 mb-4 wow fadeInLeft" data-wow-delay={newDelays[index]} >
              {/* <div className="card-container"> */}
                <div className="item-box community-services-item-box px-1" >
                  ...
                  <div className="cont ">
                    <h6>{feature.title}</h6>
                    <p className="text-center">{feature.content1}</p>
                  </div>
                </div>
              {/* </div> */}
            </div>
