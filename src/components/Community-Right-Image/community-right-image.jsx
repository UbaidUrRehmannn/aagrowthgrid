...
import AboutUs1Date from "../../data/sections/Community/community-card-left-text.json";

// const CommunityCardRightImage = () => {
//   return (
...
// export default CommunityCardRightImage;

import React from "react";

const CommunityCardRightImage = ({ data }) => {
  return (
    <section className="about-us pt-25">
      <div className="container">
        <div className="row">
